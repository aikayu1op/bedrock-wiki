...
const __pageData = JSON.parse('{"title":"RP/blocks.json | Intercardinal Orientation","description":"","frontmatter":{"title":"RP/blocks.json | Intercardinal Orientation","show_contributors":false,"license":{"code":"MIT"}},"headers":[],"params":{"file":"blocks/intercardinal-orientation/files/RP/blocks.json","name":"blocks.json","path":"RP/blocks.json","sourcePath":"rp\\\\blocks.json","example":{"id":"intercardinal_block_orientation","files":["BP/blocks/mug.json","BP/scripts/index.js","BP/scripts/intercardinalOrientation.js","BP/contents.json","BP/manifest.json","BP/pack_icon.png","RP/models/blocks/mug.geo.json","RP/textures/wiki/blocks/mug_mers.tga","RP/textures/wiki/blocks/mug.png","RP/textures/wiki/blocks/mug.texture_set.json","RP/textures/terrain_texture.json","RP/textures/textures_list.json","RP/blocks.json","RP/contents.json","RP/manifest.json","RP/pack_icon.png"],"archive":{"root":"","type":"mcaddon"}},"root":{"title":"Intercardinal Orientation","path":"blocks/intercardinal-orientation","type":"page"}},"relativePath":"blocks/intercardinal-orientation/files/RP/blocks.json.md","filePath":"[file].md"}');
const _sfc_main = { name: "blocks/intercardinal-orientation/files/RP/blocks.json.md" };
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-dark": "#9CDCFE", "--shiki-light": "#0451A5" })}">        &quot;sound&quot;</span><span style="${ssrRenderStyle({ "--shiki-dark": "#D4D4D4", "--shiki-light": "#000000" })}">: </span><span style="${ssrRenderStyle({ "--shiki-dark": "#CE9178", "--shiki-light": "#A31515" })}">&quot;metal&quot;</span></span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("blocks/intercardinal-orientation/files/RP/blocks.json.md");
