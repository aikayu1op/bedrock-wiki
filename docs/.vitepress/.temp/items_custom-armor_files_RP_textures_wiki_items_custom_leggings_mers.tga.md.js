...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("items/custom-armor/files/RP/textures/wiki/items/custom_leggings_mers.tga.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const custom_leggings_mers_tga = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  custom_leggings_mers_tga as default
};
