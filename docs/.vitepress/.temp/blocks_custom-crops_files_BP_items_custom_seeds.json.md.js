...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_CodeHeader, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`BP/items/custom_seeds.json`);
      } else {
        return [
          createTextVNode("BP/items/custom_seeds.json")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("blocks/custom-crops/files/BP/items/custom_seeds.json.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const custom_seeds_json = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  custom_seeds_json as default
};
