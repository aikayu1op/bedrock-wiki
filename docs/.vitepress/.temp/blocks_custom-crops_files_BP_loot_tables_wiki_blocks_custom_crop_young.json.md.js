...
const __pageData = JSON.parse('{"title":"BP/loot_tables/wiki/blocks/custom_crop_young.json | Custom Crops","description":"","frontmatter":{"title":"BP/loot_tables/wiki/blocks/custom_crop_young.json | Custom Crops","show_contributors":false,"license":{"code":"MIT"}},"headers":[],"params":{"file":"blocks/custom-crops/files/BP/loot_tables/wiki/blocks/custom_crop_young.json","name":"custom_crop_young.json","path":"BP/loot_tables/wiki/blocks/custom_crop_young.json","sourcePath":"bp\\\\loot_tables\\\\wiki\\\\blocks\\\\custom_crop_young.json","example":{"id":"custom_crops","files":["BP/blocks/custom_crop.json","BP/items/custom_food.json","BP/items/custom_seeds.json","BP/loot_tables/wiki/blocks/custom_crop_mature.json","BP/loot_tables/wiki/blocks/custom_crop_young.json","BP/scripts/cropGrowth.js","BP/scripts/index.js","BP/contents.json","BP/manifest.json","BP/pack_icon.png","RP/models/blocks/custom_crop.geo.json","RP/texts/en_US.lang","RP/texts/languages.json","RP/textures/wiki/blocks/custom_crop_0.png","RP/textures/wiki/blocks/custom_crop_1.png","RP/textures/wiki/blocks/custom_crop_2.png","RP/textures/wiki/blocks/custom_crop_3.png","RP/textures/wiki/items/custom_food.png","RP/textures/wiki/items/custom_seeds.png","RP/textures/item_texture.json","RP/textures/terrain_texture.json","RP/textures/textures_list.json","RP/blocks.json","RP/contents.json","RP/manifest.json","RP/pack_icon.png"],"archive":{"root":"","type":"mcaddon"}},"root":{"title":"Custom Crops","path":"blocks/custom-crops","type":"page"}},"relativePath":"blocks/custom-crops/files/BP/loot_tables/wiki/blocks/custom_crop_young.json.md","filePath":"[file].md"}');
const _sfc_main = { name: "blocks/custom-crops/files/BP/loot_tables/wiki/blocks/custom_crop_young.json.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_CodeHeader, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`BP/loot_tables/wiki/blocks/custom_crop_young.json`);
      } else {
        return [
          createTextVNode("BP/loot_tables/wiki/blocks/custom_crop_young.json")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("blocks/custom-crops/files/BP/loot_tables/wiki/blocks/custom_crop_young.json.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const custom_crop_young_json = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  custom_crop_young_json as default
};
